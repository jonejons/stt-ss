...
describe('BranchController', () => {
  ...
  describe('getBranchById', () => {
    ...
    it('should throw error when branch not found', async () => {
      ...
      await expect(controller.getBranchById('nonexistent', mockDataScope))
  ...
  describe('updateBranch', () => {
    it('should update a branch successfully', async () => {
      ...
      const result = await controller.updateBranch('branch-123', updateDto, mockUserContext, mockDataScope);
  ...
  describe('assignBranchManager', () => {
    it('should assign a branch manager successfully', async () => {
      ...
      const result = await controller.assignBranchManager('branch-123', assignDto, mockUserContext);
  ...
  describe('getBranchManagers', () => {
    it('should return branch managers', async () => {
      ...
      expect(branchService.getBranchManagers).toHaveBeenCalledWith('branch-123', mockDataScope);
  ...
  describe('getBranchWithStats', () => {
    it('should return branch with statistics', async () => {
      ...
      expect(branchService.getBranchWithStats).toHaveBeenCalledWith('branch-123', mockDataScope);
