...
describe('AuthService', () => {
  ...
  describe('login', () => {
    ...
    it('should successfully login with valid credentials', async () => {
      ...
      mockUserRepository.findUserWithOrganizations.mockResolvedValue(mockUserWithOrganizations);
      ...
      expect(PasswordUtil.compare).toHaveBeenCalledWith('TestPassword123!', 'hashed-password');
    ...
    it('should throw UnauthorizedException for non-existent user', async () => {
      ...
      await expect(service.login(loginDto, 'correlation-123')).rejects.toThrow(UnauthorizedException);
  ...
  describe('refreshToken', () => {
    ...
    it('should throw UnauthorizedException for invalid refresh token', async () => {
      ...
      await expect(service.refreshToken(refreshTokenDto, 'correlation-123')).rejects.toThrow(UnauthorizedException);
      expect(mockLogger.logSecurityEvent).toHaveBeenCalledWith(
