...
import { CreateUserDto, UpdateUserDto, ChangePasswordDto, AssignUserToOrganizationDto } from '../../shared/dto';
...
export class UserService {
   ...
   * Update user
   */
  async updateUser(id: string, updateUserDto: UpdateUserDto, correlationId?: string): Promise<User> {
    try {
  ...
  async assignToOrganization(
    assignDto: AssignUserToOrganizationDto,
    correlationId?: string,
  ) {
    try {
