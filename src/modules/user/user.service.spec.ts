...
import { CreateUserDto, UpdateUserDto, ChangePasswordDto } from '../../shared/dto';
import { PasswordUtil, DatabaseUtil } from '../../shared/utils';
...
describe('UserService', () => {
  ...
  describe('createUser', () => {
    ...
    it('should throw ConflictException for weak password', async () => {
      ...
      await expect(service.createUser(createUserDto, 'correlation-123')).rejects.toThrow(ConflictException);
  ...
  describe('updateUser', () => {
    ...
    it('should throw NotFoundException when user not found', async () => {
      ...
      await expect(service.updateUser('nonexistent', updateUserDto, 'correlation-123')).rejects.toThrow(NotFoundException);
  ...
  describe('changePassword', () => {
    ...
    it('should throw NotFoundException when user not found', async () => {
      ...
      await expect(service.changePassword('nonexistent', changePasswordDto, 'correlation-123')).rejects.toThrow(NotFoundException);
    });
    ...
    it('should throw ConflictException for invalid current password', async () => {
      ...
      await expect(service.changePassword('user-123', changePasswordDto, 'correlation-123')).rejects.toThrow(ConflictException);
  ...
  describe('assignToOrganization', () => {
    ...
    it('should handle unique constraint violation', async () => {
      ...
      await expect(service.assignToOrganization(assignDto, 'correlation-123')).rejects.toThrow(ConflictException);
    });
  });
