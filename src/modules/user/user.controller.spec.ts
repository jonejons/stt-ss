...
describe('UserController', () => {
  ...
  describe('getUserById', () => {
    ...
    it('should throw error when user not found', async () => {
      ...
      await expect(controller.getUserById('nonexistent', mockScope)).rejects.toThrow('User not found');
    });
  });
  ...
  describe('updateUser', () => {
    it('should update user', async () => {
      ...
      expect(mockUserService.updateUser).toHaveBeenCalledWith('user-123', updateUserDto, 'user-123');
  ...
  describe('changeUserPassword', () => {
    it('should change user password', async () => {
      ...
      expect(mockUserService.changePassword).toHaveBeenCalledWith('user-123', changePasswordDto, 'user-123');
    });
  });
  ...
  describe('assignUserToOrganization', () => {
    it('should assign user to organization', async () => {
      ...
      const result = await controller.assignUserToOrganization('user-123', assignDto, mockUser);
  ...
  describe('removeUserFromOrganization', () => {
    it('should remove user from organization', async () => {
      ...
      expect(mockUserService.removeFromOrganization).toHaveBeenCalledWith('user-123', 'org-456', 'user-123');
    });
  });
  ...
  describe('getUserOrganizations', () => {
    ...
    it('should throw error when user not found', async () => {
      ...
      await expect(controller.getUserOrganizations('nonexistent')).rejects.toThrow('User not found');
    });
  });
});