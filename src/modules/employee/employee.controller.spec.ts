...
describe('EmployeeController', () => {
  ...
  describe('createEmployee', () => {
    it('should create an employee successfully', async () => {
      ...
      const result = await controller.createEmployee(createDto, mockUserContext, mockDataScope);
  ...
  describe('getEmployeesByBranch', () => {
    it('should return employees for a specific branch', async () => {
      ...
      expect(employeeService.getEmployeesByBranch).toHaveBeenCalledWith('branch-123', mockDataScope);
  ...
  describe('getEmployeesByDepartment', () => {
    it('should return employees for a specific department', async () => {
      ...
      expect(employeeService.getEmployeesByDepartment).toHaveBeenCalledWith('dept-123', mockDataScope);
      expect(result).toHaveLength(1);
      expect(result[0].id).toBe(mockEmployee.id);
    });
  });
  ...
  describe('getEmployeeById', () => {
    ...
    it('should throw error when employee not found', async () => {
      ...
      await expect(controller.getEmployeeById('nonexistent', mockDataScope))
  ...
  describe('getEmployeeByCode', () => {
    ...
    it('should throw error when employee not found by code', async () => {
      ...
      await expect(controller.getEmployeeByCode('NONEXISTENT', mockDataScope))
        .rejects.toThrow('Employee not found');
    });
  });
  ...
  describe('updateEmployee', () => {
    it('should update an employee successfully', async () => {
      ...
      const result = await controller.updateEmployee('emp-123', updateDto, mockUserContext, mockDataScope);
  ...
  describe('toggleEmployeeStatus', () => {
    it('should toggle employee status successfully', async () => {
      ...
      const result = await controller.toggleEmployeeStatus('emp-123', false, mockUserContext, mockDataScope);
  ...
  describe('getEmployeeCountByBranch', () => {
    it('should return employee count for a branch', async () => {
      ...
      expect(employeeService.getEmployeeCountByBranch).toHaveBeenCalledWith('branch-123', mockDataScope);
  ...
  describe('getEmployeeCountByDepartment', () => {
    it('should return employee count for a department', async () => {
      ...
      expect(employeeService.getEmployeeCountByDepartment).toHaveBeenCalledWith('dept-123', mockDataScope);
