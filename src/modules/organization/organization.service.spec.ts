...
describe('OrganizationService', () => {
  ...
  describe('createOrganization', () => {
    ...
    it('should create organization successfully', async () => {
      ...
      const result = await service.createOrganization(createOrganizationDto, 'user-123', 'correlation-456');
    ...
    it('should handle unique constraint violation', async () => {
      ...
      await expect(service.createOrganization(createOrganizationDto, 'user-123')).rejects.toThrow(ConflictException);
    });
  });
  ...
  describe('updateOrganization', () => {
    ...
    it('should update organization successfully', async () => {
      ...
      const result = await service.updateOrganization('org-123', updateOrganizationDto, 'user-123', 'correlation-456');

      expect(mockOrganizationRepository.findById).toHaveBeenCalledWith('org-123');
      expect(mockOrganizationRepository.update).toHaveBeenCalledWith('org-123', updateOrganizationDto);
      expect(mockLogger.logUserAction).toHaveBeenCalledWith(
        'user-123',
    ...
    it('should throw NotFoundException when organization not found', async () => {
      ...
      await expect(service.updateOrganization('nonexistent', updateOrganizationDto, 'user-123')).rejects.toThrow(NotFoundException);
    ...
    it('should handle unique constraint violation', async () => {
      ...
      await expect(service.updateOrganization('org-123', updateOrganizationDto, 'user-123')).rejects.toThrow(ConflictException);
    });
  });
  ...
  describe('deleteOrganization', () => {
    ...
    it('should throw NotFoundException when organization not found', async () => {
      ...
      await expect(service.deleteOrganization('nonexistent', 'user-123')).rejects.toThrow(NotFoundException);
  ...
  describe('getOrganizationWithStats', () => {
    ...
    it('should throw NotFoundException when organization not found', async () => {
      ...
      await expect(service.getOrganizationWithStats('nonexistent')).rejects.toThrow(NotFoundException);
    });
  });
