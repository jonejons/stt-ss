...
export class GuestRepository {
  ...
  async update(
    ...
    if (data.responsibleEmployeeId !== undefined) updateData.responsibleEmployeeId = data.responsibleEmployeeId;
    if (data.scheduledEntryTime !== undefined) updateData.scheduledEntryTime = new Date(data.scheduledEntryTime);
    if (data.scheduledExitTime !== undefined) updateData.scheduledExitTime = new Date(data.scheduledExitTime);
    if (data.status !== undefined) updateData.status = data.status;
    if (data.accessCredentialType !== undefined) updateData.accessCredentialType = data.accessCredentialType;
    if (data.accessCredentialHash !== undefined) updateData.accessCredentialHash = data.accessCredentialHash;
