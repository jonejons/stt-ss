...
export class DepartmentController {
  ...
  async searchDepartments(
    ...
    const departments = await this.departmentService.searchDepartments(searchTerm.trim(), scope);
  ...
  private mapDepartmentWithChildren(department: any): any {
    return {
      ...
      createdAt: department.createdAt,
      updatedAt: department.updatedAt,
      children: department.children ? department.children.map(child => this.mapDepartmentWithChildren(child)) : [],
    };
  }
}