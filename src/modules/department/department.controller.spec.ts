...
describe('DepartmentController', () => {
  ...
  describe('createDepartment', () => {
    it('should create a department successfully', async () => {
      ...
      const result = await controller.createDepartment(createDto, mockUserContext, mockDataScope);
  ...
  describe('getDepartmentsByBranch', () => {
    it('should return departments for a specific branch', async () => {
      ...
      expect(departmentService.getDepartmentsByBranch).toHaveBeenCalledWith('branch-123', mockDataScope);
  ...
  describe('getDepartmentHierarchy', () => {
    it('should return department hierarchy for a branch', async () => {
      ...
      expect(departmentService.getDepartmentHierarchy).toHaveBeenCalledWith('branch-123', mockDataScope);
      expect(result).toHaveLength(1);
  ...
  describe('updateDepartment', () => {
    it('should update a department successfully', async () => {
      ...
      const result = await controller.updateDepartment('dept-123', updateDto, mockUserContext, mockDataScope);
