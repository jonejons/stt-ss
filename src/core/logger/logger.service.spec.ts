...
describe('LoggerService', () => {
  ...
  describe('logDatabaseOperation', () => {
    it('should log database operation with proper context', () => {
      service.logDatabaseOperation('CREATE', 'Employee', 'emp-123', 'user-456', 'org-789', 'corr-abc');
  ...
  describe('logQueueJob', () => {
    it('should log successful job completion', () => {
      service.logQueueJob('ProcessEvent', 'job-123', 'completed', 1500, undefined, 'corr-456');
    ...
    it('should log failed job as error', () => {
      service.logQueueJob('ProcessEvent', 'job-123', 'failed', 500, 'Connection timeout', 'corr-456');
